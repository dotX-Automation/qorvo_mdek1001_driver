/**
 * Qorvo MDEK1001 Driver standalone application.
 *
...
int main(int argc, char ** argv)
{
  ROS2AppManager<rclcpp::executors::SingleThreadedExecutor,
    qorvo_mdek1001_driver::QorvoMDEK1001Driver> app_manager(
      argc,
      argv,
      "qorvo_mdek1001_driver_app");

  SignalHandler & sig_handler = SignalHandler::get_global_signal_handler();
  sig_handler.init(
    app_manager.get_context(),
    "qorvo_mdek1001_driver_app_signal_handler",
